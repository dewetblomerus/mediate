defmodule MediateWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: MediateWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MediateWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MediateWeb.Gettext, "errors", msg, opts)
    end
  end
